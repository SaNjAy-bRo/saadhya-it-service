        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span className="font-sans text-sm text-slate-900 leading-relaxed mt-1 block font-semibold">
                        {benefit.desc}
                      </span>
                    </div>
                  </div>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start">
              <a
                href="#services"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-primary hover:bg-primary-dark text-white font-extrabold text-sm transition-all shadow-md"
              >
